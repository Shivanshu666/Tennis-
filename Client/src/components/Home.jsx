...
const Home = () => {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          event: (
            <>
              Master Class Tennis Clinic 'The Winning Mindset' by<strong> Mr. Vishnu Vardhan - Professional Tennis Player (an Olympian, Asian Games Medalist, Grand Slam & Davis Cup Player)</strong> 
            </>
          )
          ,
        },
        {
          ...
          event:(
            ...
            Hit Out & Rally Challenge with <strong>Mr. Vishnu Vardhan</strong>
            </>
          )
        },
        {
  ...
  return (
    <div className=" bg-gray-50">
              ...
              {['Home', 'About', 'Categories', 'Schedule', 'Sponsors', 'Gallery', 'Contact'].map(item => {
                ...
                return (
                  <a
                    ...
                    className={`relative px-4 py-2 font-semibold transition-all duration-300 group ${isActive ? 'text-blue-600' : 'text-gray-700 hover:text-blue-600'
                      }`}
                  >
              ...
              {['Home', 'About', 'Categories', 'Schedule', 'Sponsors', 'Gallery', 'Contact'].map(item => {
                ...
                return (
                  <a
                    ...
                    href={`#${sectionId}`}
                    onClick={(e) => handleNavClick(e, sectionId)}
                    className={`flex items-center space-x-2 py-3 px-3 rounded-xl font-semibold transition-all duration-300 group ${isActive
      ...
      <section
        id="home"
        className="relative min-h-screen flex flex-col items-center justify-center p-7 md:pt-9 overflow-hidden"
      >
        {/* Background Image */}
        <div
        ...
        <div
          ref={entryFeeRef}
          className="hidden md:block absolute md:top-70 lg:top-32 right-4 lg:right-8 z-20 cursor-pointer"
        >
        ...
        {/* --- MAIN CONTENT --- */}
        <div className="relative z-10 max-w-6xl mx-auto px-4 text-center py-14 flex flex-col items-center gap-6">
          ...
          <div className="flex flex-col items-center justify-center gap-6 w-full">
            {/* Highlight Button */}
            <div className="inline-flex flex-col md:flex-row items-center bg-gradient-to-r from-purple-700 to-blue-700 backdrop-blur-sm border border-purple-400 rounded-full px-6 py-4 md:px-8 md:py-4 shadow-2xl shadow-purple-900/50 hover:scale-105 transition-all duration-500 relative group cursor-pointer overflow-hidden text-center">
              <div className="absolute inset-0 rounded-full opacity-30 group-hover:opacity-60 transition-opacity duration-500" style={{ backgroundImage: 'radial-gradient(circle at center, rgba(255, 255, 255, 0.2), transparent 70%)' }}></div>
              <svg className="w-6 h-6 text-yellow-300 mb-2 md:mb-0 md:mr-4 animate-pulse drop-shadow-lg shadow-yellow-500/80 z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Logo */}
            <img src={sport} alt="Logo" className="w-40 md:w-100 h-auto rounded-full shadow-2xl object-cover" />
          </div>

          {/* DATE + VENUE */}
          <div className="w-full mx-auto mb-10">
            <div className="w-full bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-5 hover:shadow-xl hover:scale-[1.015] transition-all duration-300 relative overflow-hidden group">
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent -skew-x-12 translate-x-[-120%] group-hover:translate-x-[120%] transition-transform duration-[1200ms]"></div>
              <div className="flex flex-col sm:flex-row items-start sm:justify-between gap-6 relative z-10">
                {/* DATE */}
                <div className="flex items-start gap-3">
                  <Calendar className="w-4 h-4 text-blue-300 mt-[2px]" />
                  <div>
                    <p className="text-blue-200 text-[15px] font-bold uppercase tracking-widest">Tournament Date</p>
                    <p className="text-white font-bold text-lg leading-tight">20 - 21 Dec., 2025</p>
                  </div>
                </div>
          ...
          {/* Description */}
          <p className="text-base md:text-lg text-gray-200 max-w-3xl mx-auto leading-relaxed mb-10 px-2 md:px-4">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 w-full">
            ...
            <div className="md:hidden bg-gradient-to-br from-yellow-400 to-orange-500 rounded-xl p-3 shadow-xl border-2 border-yellow-300 animate-pulse w-full text-center">
  ...
  ">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex justify-center items-center space-x-8 mb-6">
                      ...
                      <div className="relative animate-bounce">
                        <div className="bg-blue-300/20 rounded-full p-4 sm:p-5 backdrop-blur-sm border-2 border-blue-300/50 shadow-lg">
                      ...
                      <div className="relative animate-bounce" style={{ animationDelay: '0.3s' }}>
                        ...
                        <div className="absolute -top-2 -right-2 animate-spin" style={{ animationDelay: '0.5s' }}>✨</div>
                        <div className="absolute -bottom-2 -left-2 animate-ping" style={{ animationDelay: '0.7s' }}>🎽</div>
                      </div>
                      ...
                      <div className="relative animate-bounce" style={{ animationDelay: '0.6s' }}>
                        ...
                        <div className="absolute -top-2 -right-2 animate-spin" style={{ animationDelay: '0.8s' }}>✨</div>
                        <div className="absolute -bottom-2 -left-2 animate-ping" style={{ animationDelay: '1s' }}>⭐</div>
                      </div>
                    </div>
                      ...
                      <div className="space-y-2">
                        <p className="text-blue-100 text-lg sm:text-xl font-semibold leading-relaxed">
                          <span className="bg-blue-500/20 px-3 py-2 rounded-lg backdrop-blur-sm inline-block scale-105 border border-blue-300/30">
                            💰 Cash Prizes • 🎁 Exciting Gifts • 👕 Participation T-shirt
                          </span>
                        </p>
                        <p className="text-blue-100 text-lg sm:text-xl font-semibold leading-relaxed">
                          <span className="bg-blue-500/20 px-3 py-2 rounded-lg backdrop-blur-sm inline-block scale-105 border border-blue-300/30">
                ...
                {/* Additional Floating Icons Around Container */}
                <div className="absolute top-4 left-10 animate-bounce" style={{ animationDelay: '0.4s' }}>
                  <div className="text-2xl">💰</div>
                </div>
                <div className="absolute top-8 right-16 animate-bounce" style={{ animationDelay: '0.7s' }}>
                  <div className="text-2xl">👕</div>
                </div>
                <div className="absolute bottom-6 left-20 animate-bounce" style={{ animationDelay: '0.9s' }}>
                  <div className="text-2xl">🏆</div>
                </div>
                <div className="absolute bottom-10 right-10 animate-bounce" style={{ animationDelay: '1.1s' }}>
                  <div className="text-2xl">💵</div>
                </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    disabled={isSubmitting}
                    className={`w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white py-4 rounded-xl font-bold transition-all duration-300 transform hover:-translate-y-1 shadow-lg hover:shadow-xl flex items-center justify-center space-x-2 ${isSubmitting
