...
//         success: false,
//         msg: "All fields are required: name, email,phone and message" 
//       });
//     }
...
const insertUser = async (req, res) => {
  try {
    ...
    // Validation - Only name, email, phone and message are required
    if (!name || !email || !phone || !message) {
      return res.status(400).json({
        success: false,
        msg: "All fields are required: name, email, phone and message",
    ...
    const userMailOptions = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="text-align: center; margin-bottom: 30px;">
            <h2 style="color: #2563eb; margin-bottom: 10px;">Thank You for Your Message!</h2>
            <p style="color: #64748b; font-size: 16px;">We've received your inquiry and will get back to you shortly.</p>
          </div>
